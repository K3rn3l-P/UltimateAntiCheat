...
Original working notes from this fork, kept as they were.
...
- Assicurati che tutti i file richiesti (DLL, exe, config) siano nella cartella corretta.
- Se modifichi CMakeLists.txt o aggiungi file, rigenera sempre con `cmake ..`.
- Puoi aprire la soluzione generata in `build/` anche da Visual Studio dopo questi passaggi.

---

Questa sequenza risolve molti problemi di cache/configurazione che a volte Visual Studio IDE non pulisce bene.
